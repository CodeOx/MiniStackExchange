...
public final class commentpage_jsp extends org.apache.jasper.runtime.HttpJspBase
      ...
      out.write("                                                    ");
        ...
        try (Connection connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/group_31", "postgres", "1234")) {
            ...
            if(rs.next()){
                ...
                out.println("<form action=\"commentservlet\" method=\"post\"><textarea name=\"textarea\" rows=10></textarea><br><input type=\"submit\" value=\"Comment\">   <a href=\"postpage.jsp?postid="+s+"\" class=\"button primary\">Cancel</a></form>");
                }
