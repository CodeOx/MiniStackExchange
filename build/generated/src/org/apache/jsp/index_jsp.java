...
public final class index_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                </div>\n");
      out.write("<br>\n");
      out.write("        <h3><center>Here is how MiniStackExchange is different from other Q&A sites:</center></h3>\n");
      out.write("\t\t\t\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<header>\n");
      out.write("                                                                    \n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"icon fa-line-chart\"><span class=\"label\">Icon</span></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3>Expert Community</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</header>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Each of our communities is built by people passionate about a focused topic.\n");
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t\t\t\t<header>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"icon fa-paper-plane-o\"><span class=\"label\">Icon</span></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3>The right answer. Right on top.</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</header>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Experts like you can vote on posts, so the most helpful answers are easy to find.\n");
      out.write("</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t\t<section>\n");
      out.write("\t\t\t\t\t\t\t<div class=\"content\">\n");
      out.write("\t\t\t\t\t\t\t\t<header>\n");
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"#\" class=\"icon fa-qrcode\"><span class=\"label\">Icon</span></a>\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3>Share knowledge. Earn trust.</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</header>\n");
      out.write("\t\t\t\t\t\t\t\t<p>Earn reputation and additional privileges for posts others find helpful.</p>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t</section>\n");
      out.write("\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</div>\n");
      ...
      out.write("                    </form>\n");
      out.write("                        <br>\n");
      out.write("                    <center><H2>recent posts</h2></center>\n");
...
Connection conn=null;
        ...
        conn=DriverManager.getConnection("jdbc:postgresql://10.17.50.115:5432/group_31", "group_31", "235-563-714");
        String posttext;
        int postid;
